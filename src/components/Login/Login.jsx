...
// code 2
    ...
    async function Logincheck(e) {
        ...
        if (username ==='' || password === '') {
            ...
            axios.post(`http://localhost:9191/login`, loginUser)
                .then((response) => {
            ...
            axios.get(`http://localhost:9191/users/${db_username}`).then((response) => {
                  ...
                  <Col lg={8} md={6} sm={12} className="container p-3 m-auto shadow-lg p-3 mb-5 bg-body rounded" style={{background:"#2d143e"}}>
                    ...
                    <h1 className='text-center '>Login Here</h1>
                        ...
                        <h6>Don't have an account?</h6>
                            <Button variant="success" className='btn btn-primary mb-1 mt-2' style={{background:"Green"}} onClick={RouteToSignUp}  >Sign Up</Button>
