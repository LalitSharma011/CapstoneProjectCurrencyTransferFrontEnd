...
function Payment() {
 ...
 let loggedUser = JSON.parse(localStorage.getItem('loggedUser'))
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:9191/BankDetails`)
            ...
            axios.get(`http://localhost:9191/verification/${loggedUser.emailid}`)
    ...
    const Pay = (event) => {
        ...
        { 
            ...
            axios.post(`http://localhost:9191/payments`, newPayment)
            ...
            axios.post(`http://localhost:9191/BankDetails`, updatedAccount)
        ...
        <div>
            ...
            <nav class="navbar fixed-top navbar-expand-md navbar-dark  mb-3" style={{ background: "#5E10B1", color: "white" }}>
                <div class="flex-row d-flex" >
                    ...
                    <a class="navbar-brand ml-2" href="#" title="Free Bootstrap 4 Admin Template">NatWest</a>
                </div>
                ...
                <div class="navbar-collapse collapse" id="collapsingNavbar">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <Nav.Link class="nav-link" href="/" data-target="#myModal" data-toggle="modal" onClick={logout} >LogOut</Nav.Link>
                        </li>
                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start " id="menu">
                                ...
                                <li>
                                    <Nav.Link href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle " style={{ color: "black" }}>
                                        ...
                                        <span class="ms-1 d-none d-sm-inline">Card services</span> </Nav.Link>
